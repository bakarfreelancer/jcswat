  <header id="headSlider">
    ...
    <div>
      <a class="carousel-control-prev sliderNavigators hide" href="#carouselExampleIndicators" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="carousel-control-next sliderNavigators hide" href="#carouselExampleIndicators" role="button" data-slide="next">
